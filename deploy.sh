...
# sudo docker run -it -d --link mysql-server:mysql-server -v /:/workdir -p 20001:20001 -p 20002:20002 --name tornado-env tornado-env:0.1 bash -c "cd /workdir/QSZ/QSZ && ./deploy online"
case "$@" in
	online)
